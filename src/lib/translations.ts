...
export const translations = {
    en: {
        ...
        notebook: {
            ...
            queueCountTitle: "Pending tasks",
            retryAll: "Retry-all",
            pause: "Pause",
            resume: "Resume",
            queueEmpty: "No tasks",
            queueOffline: "Offline now",
            queueOnline: "Online now",
            queueLastRun: "Last run",
            queueLastRunSuccess: "Succeeded",
            queueLastRunSkipped: "Skipped",
            queueLastRunError: "Failed",
            queueFallbackHint: "Settings sync unavailable; using local offline config.",
            queueFallbackUsingLocalHint: "Settings sync unavailable; using local offline config.",
            queueFallbackNoLocalHint: "Settings sync unavailable and no local config found. Configure AI in Settings.",
        },
        notebooks: {
            title: "My Notebooks",
    ...
    zh: {
        ...
        notebook: {
            ...
            queueLastRunSkipped: "已跳过",
            queueLastRunError: "执行失败",
            queueFallbackHint: "设置同步失败，已使用本地离线配置。",
            queueFallbackUsingLocalHint: "设置同步失败，已使用本地离线配置。",
            queueFallbackNoLocalHint: "设置同步失败且未找到本地配置，请先在设置中配置 AI。",
        },
        notebooks: {
            title: "我的错题本",
